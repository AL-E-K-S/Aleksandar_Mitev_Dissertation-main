...
def train(model,device,the_dataloader, optim,epochs):
    ...
    for epoch in range(epochs):
        ...
        Regular_3D_2D_Hybrid_Time = open(('Regular_3D_2D_Hybrid_Training_Time.txt'), "w" ) 
        Regular_3D_2D_Hybrid_Time.write("Training time:" + str(execution_time) + "s" + "\n") 
        ...
        Regular_3D_2D_Hybrid_Conf_Met_Values = open(('Regular_3D_2D_Hybrid_Conf_Met_Values_Training.txt'), "w" ) 
        Regular_3D_2D_Hybrid_Conf_Met_Values.write("Predicted values: " + str(predicted_y) + "\n" + "Actual values:" + str(actual_y)) 
        Regular_3D_2D_Hybrid_Conf_Met_Values.close() 
...
def test(model,device,the_dataloader):
    ...
    Regular_3D_2D_Hybrid_Testing_Loss = open(("Regular_3D_2D_Hybrid_Testing_Loss.csv"), "w" ,newline='') # opens the csv
    csvWritingFileObject = csv.writer(Regular_3D_2D_Hybrid_Testing_Loss) # creates an instance of teh class that will write to teh csv
    rowOfData = [batch_list,loss_list] # image details to be added to teh csv
    csvWritingFileObject.writerow(rowOfData) 
    
    # predicted and actual values for confusion matrix
    Regular_3D_2D_Hybrid_Conf_Met_Values = open(('Regular_3D_2D_Hybrid_Conf_Met_Values_Testing.txt'), "w" ) 
    Regular_3D_2D_Hybrid_Conf_Met_Values.write("Predicted values: " + str(predicted_y) + "\n" + "Actual values:" + str(actual_y)) 
    Regular_3D_2D_Hybrid_Conf_Met_Values.close() 
...
pretrained3D_2D_Hybrid = train(ReLUModel, 'cpu',load_training_data,optim,epochs=100) # ?
...
pretrained3D_2D_Hybrid_ELU = train(ELUModel, 'cpu',load_training_data,optim,epochs=100) # ?
