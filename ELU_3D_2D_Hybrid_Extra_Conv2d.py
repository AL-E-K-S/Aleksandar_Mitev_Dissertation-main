...
def train(model,device,the_dataloader, optim,epochs):
    ...
    for epoch in range(epochs):
        ...
        ELU_Plus_2d_3D_2D_Hybrid_Time = open(('ELU_Plus_2d_3D_2D_Hybrid_Training_Time.txt'), "w" ) 
        ELU_Plus_2d_3D_2D_Hybrid_Time.write("Training time:" + str(execution_time) + "s" + "\n") 
        ELU_Plus_2d_3D_2D_Hybrid_Time.close() 

        ELU_Plus_2d_3D_2D_Hybrid_Testing_Loss = open(("ELU_Plus_2d_3D_2D_Hybrid_Training_Loss.csv"), "w" ,newline='') # opens the csv
        csvWritingFileObject = csv.writer(ELU_Plus_2d_3D_2D_Hybrid_Testing_Loss) # creates an instance of teh class that will write to teh csv
        ...
        ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values = open(('ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values_Training.txt'), "w" ) 
        ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values.write("Predicted values: " + str(predicted_y) + "\n" + "Actual values:" + str(actual_y)) 
        ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values.close() 
...
def test(model,device,the_dataloader):
    ...
    end_time = time.time()
    execution_time = end_time - start_time
    ELU_Plus_2d_3D_2D_Hybrid_Time = open(('ELU_Plus_2d_3D_2D_Hybrid_Time.txt'), "w" ) 
    ELU_Plus_2d_3D_2D_Hybrid_Time.write("Testing time:" + str(execution_time) + "s" + "\n") 
    ELU_Plus_2d_3D_2D_Hybrid_Time.close() 

    ELU_Plus_2d_3D_2D_Hybrid_Testing_Loss = open(("ELU_Plus_2d_3D_2D_Hybrid_Testing_Loss.csv"), "w" ,newline='') # opens the csv
    csvWritingFileObject = csv.writer(ELU_Plus_2d_3D_2D_Hybrid_Testing_Loss) # creates an instance of teh class that will write to teh csv
    rowOfData = [batch_list,loss_list] # image details to be added to teh csv
    csvWritingFileObject.writerow(rowOfData) 
    
    # predicted and actual values for confusion matrix
    ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values = open(('ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values_Testing.txt'), "w" ) 
    ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values.write("Predicted values: " + str(predicted_y) + "\n" + "Actual values:" + str(actual_y)) 
    ELU_Plus_2d_3D_2D_Hybrid_Conf_Met_Values.close() 
...
ELU_Plus_2dModel = ELU_Plus_2d_Hybrid_3D_2D()




optim = optimizers.SGD(ELU_Plus_2dModel.parameters(),lr=0.0005)# transfer learning paper > used 0.0005 for transfer learning 
